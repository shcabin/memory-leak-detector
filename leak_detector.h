...
extern void *xrealloc(void *str, int size, const char *file, unsigned int line,
               const char *func);
...
extern char *xstrdup(const char *str, const char *file, unsigned int line,
              const char *func);
extern void xfree(void *mem_ref, const char *file, unsigned int line,
           const char *func);
...
#define calloc(elements, size)                                                 \
  xcalloc(elements, size, __FILE__, __LINE__, __func__)
